...
def wifite():
	print Y+"HIT ENTER TO RUN DEFAULT WIFITE"
...
def airo():
	print Y+"! DONT TYPE AIRODUMP-NG ONLY TYPE THE ARGUMENTS !"
	d = raw_input(N+"[AIRODUMP]> ")
	os.system("airodump-ng " + d)
def multih():
